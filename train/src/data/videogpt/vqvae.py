...
class VQVAE(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        x = batch['video']
        recon_loss, _, vq_output = self.forward(x)
        self.log('val/recon_loss', recon_loss, prog_bar=True, logger=True, on_step=True, on_epoch=True)
        self.log('val/perplexity', vq_output['perplexity'], prog_bar=True, logger=True, on_step=True, on_epoch=True)
        self.log('val/commitment_loss', vq_output['commitment_loss'], prog_bar=True, logger=True, on_step=True, on_epoch=True)
